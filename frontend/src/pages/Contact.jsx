    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row mb-28 gap-10 text-sm">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <button className='border border-black px-8 py-4  text-black rounded-xl text-sm hover:bg-black hover:text-white transition-all duration-300 ' >Explore Jobs</button>
        </div>
      </div>
    </div>
  );
