  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-4 md:flex-row mb-20 ">
        <div className="border px-10 md:px-16 sm:py-16 flex flex-col gap-5 text-[15px] hover:text-white  hover:bg-primary transition-all duration-300 text-gray-600 cursor-pointer ">
          <b>EFFICIENCY</b>
          <p>
